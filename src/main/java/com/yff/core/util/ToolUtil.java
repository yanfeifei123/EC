...
public class ToolUtil {
    ...
    public static String requestNullofString(String st) {
        if (st == null) {
            return "";
        } else if ("null".equals(st)) {
            return "";
        }
        return st;
    }
    ...
    public static String MD5(String plainText) {
        ...
        try {
            ...
            s = sb.toString().substring(0, 32);//从下标0开始，length目的是截取多少长度的值
        } catch (Exception e) {
            e.printStackTrace();
        }
        return s;
